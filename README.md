...
<table data-card-size="large" data-view="cards">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Sync with a Git repository to enable docs-as-code workflows</td>
      <td><a href="git-sync">git-sync</a></td>
    ...
    <tr>
      <td><strong>Create content</strong></td>
      <td>Create and format your docs using our block-based editor</td>
      <td><a href="../creating-content">creating-content</a></td>
    ...
    <tr>
      ...
      <td>Publish your docs site to share with others</td>
      <td><a href="../publishing-documentation">publishing-documentation</a></td>
