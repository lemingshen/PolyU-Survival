...
- Click "Settings" on the left panel and click "Payments profile"
  <figure><img src="../../.gitbook/assets/research/llms/google/payment_profile.png" alt=""><figcaption></figcaption></figure>

- Then, scroll down to the bottom of the page and click "Close payment profile".
  <figure><img src="../../.gitbook/assets/research/llms/google/close_profile.png" alt=""><figcaption></figcaption></figure>
...
- Enter your credit/debit card (MasterCard & VISA) information **(CN/HK cards are all acceptable)**. The billing address **MUST** be in US.
  ...
  Make sure your billing address or account address is in tax-free states (_e.g._, Oregon). You can generate a US address [here](https://www.fakexy.com/fake-address-generator-us).
  {% endhint %}
  <figure><img src="../../.gitbook/assets/research/llms/google/credit_card.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/research/llms/google/play_region.png" alt=""><figcaption></figcaption></figure>

{% hint style="danger" %}

### IMPORTANT

Please note that Google Play Store may take several hours to change to the US region. As long as your [payment profile](https://payments.google.com/gp/w/u/0/home/settings) is in US, your accout would be OK.
{% endhint %}
